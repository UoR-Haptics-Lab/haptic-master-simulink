...
#define S_FUNCTION_NAME  sfun_positionControl
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    // Set new position of x-direction spring
    setSpringLocation(hapticMasterDeviceHandle, springNameX, &x);

    // Set new position of y-direction spring
    setSpringLocation(hapticMasterDeviceHandle, springNameY, &x);

    // Set new position of z-direction spring
    setSpringLocation(hapticMasterDeviceHandle, springNameZ, &x);
